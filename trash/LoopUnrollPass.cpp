...
INITIALIZE_PASS_BEGIN(LoopUnroll, "air-loop-unroll", "air Unroll loops", false, false)
INITIALIZE_PASS_DEPENDENCY(LoopInfo)
INITIALIZE_PASS_DEPENDENCY(LoopSimplify)
INITIALIZE_PASS_DEPENDENCY(LCSSA)
INITIALIZE_PASS_END(LoopUnroll, "air-loop-unroll", "air Unroll loops", false, false)
